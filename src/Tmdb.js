...
export default {
    ...
    // Função responsável por buscar informações o filme destaque
    getMovieInfo: async (movieId, type) => {
        let info = {};

        // Primeiro verifica se existe um Id, ou seja, se existe um filme
        if(movieId) {
            // Faz a alternância entre filme e série, pois possuem informações diferentes
            switch(type) {
                case 'movie':
